...
function PDFViewer({ pdfPath, scale, activeDocId, onDocumentLoadSuccess, onPageInView }) {
    _s();
    ...
    const handleLoadSuccess = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PDFViewer.useCallback[handleLoadSuccess]": ({ numPages: pages })=>{
            setNumPages(pages);
            onDocumentLoadSuccess(pages);
        }
    }["PDFViewer.useCallback[handleLoadSuccess]"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PDFViewer.useEffect": ()=>{
            ...
            const observer = new IntersectionObserver({
                "PDFViewer.useEffect": (entries)=>{
                    const visible = entries.filter({
                        "PDFViewer.useEffect.visible": (e)=>e.isIntersecting
                    }["PDFViewer.useEffect.visible"]);
                    if (visible.length === 0) return;
                    const topEntry = visible.reduce({
                        "PDFViewer.useEffect.topEntry": (prev, curr)=>prev.boundingClientRect.top < curr.boundingClientRect.top ? prev : curr
                    }["PDFViewer.useEffect.topEntry"]);
            ...
            elements?.forEach({
                "PDFViewer.useEffect": (el)=>observer.observe(el)
            }["PDFViewer.useEffect"]);
            return ({
                "PDFViewer.useEffect": ()=>{
                    observer.disconnect();
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$pdf$2f$dist$2f$Document$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Document$3e$__["Document"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "w-8 h-8 border-2 border-[#134D8B] border-t-transparent rounded-full animate-spin mx-auto mb-3"
                        }, void 0, false, {
            ...
            error: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-sm",
                    children: "Không thể tải slide. Vui lòng thử lại."
                }, void 0, false, {
                    fileName: "[project]/src/components/PDFViewer.tsx",
                    lineNumber: 79,
                    columnNumber: 13
...
_s(PDFViewer, "vwQEDBjlu8KBRv0qvGMBsMUfqnE=");
_c = PDFViewer;
var _c;
...
"[project]/src/components/PDFViewer.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {
